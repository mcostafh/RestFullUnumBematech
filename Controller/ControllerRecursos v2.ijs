...
var ServiceRecursos = function () {
  ngin.router.Controller.call(this);
};

goog.inherits(ServiceRecursos, ngin.router.Controller);

ServiceRecursos.prototype.getRecurso = function (request, partNumber) {

    var result = {}
    try{

        dsRecursos = classes.getCachedDataSet(-2007800000) //recurso
...
ServiceRecursos.prototype.updRecurso = function (request, partNumber) {
    ...
    try{
        dsRecursos = connection.cloneLocalCacheByClass( -2007800000)
        dsRecursos.indexFieldNames = 'codigo'
...
module.exports = ServiceRecursos;